...
from src.schemas.theme_event import ThemeDefinitionSchema, ThemeRegistrySchema
...
class ThemeRegistryService:
    ...
    def __init__(self, registry_path: Optional[Path | str] = None):
        ...
        self.registry_path = Path(registry_path) if registry_path else repo_root / "data" / "theme_registry.json"
        self.example_registry_path = repo_root / "src" / "data" / "theme_registry.example.json"
        self._lock = RLock()
